...
export default function PostsPage({ slug }) {
  ...
  return (
    <div>
      <div className="text-center py-10 w-full bg-light dark:bg-dark">
        <h2 className="text-dark dark:text-light  uppercase ">
          {slug === "featured-posts" ? "Featured Posts" : "Most Popular Posts"}
        </h2>
      </div>
      <div className="section-container py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-6 bg-white dark:bg-black">
        ...
        <div className="flex-1">
          <div>
            <h3 className="text-dark dark:text-light leading-5">
              Latest Posts
            </h3>
            {latestPosts.map((latestPost) => (
              <PostFeed
                ...
                className={
                  "border-b border-b-gray dark:border-b-dark-gray py-5 flex flex-row gap-2 items-center"
                }
